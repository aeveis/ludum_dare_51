...
class OptionsMenu extends UIImage
{
	...
	public function new()
	{
		...
		optionsList.addOption(makeToggleOption("Type Text", UIPlacement.Grid(0, 1), UISize.Grid(1, 1), toggleTyping, !AniBitmapText.noTyping));
		optionsList.addOption(makeToggleOption("Anim Text", UIPlacement.Grid(1, 1), UISize.Grid(1, 1), toggleTextAnimation, !AniBitmapText.noAnimation));
	...
	{
		AniBitmapText.noTyping = !AniBitmapText.noTyping;
	}

	public function toggleTextAnimation()
	{
		AniBitmapText.noAnimation = !AniBitmapText.noAnimation;
	}
}
